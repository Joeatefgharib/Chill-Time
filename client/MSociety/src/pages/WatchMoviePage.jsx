...
const WatchMoviePage = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://msociety.onrender.com/api/movies/${id}`)
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`https://msociety.onrender.com/api/movies/${id}/qualities/${type}`)
      .then((response) => {
        console.log(response.data);
  ...
  return (
    <StyledContainer>
      <IoMdCloseCircle
        className={
          " lg:absolute lg:left-0 lg:mt-[85px] lg:ml-[50px] lg:w-[3.5em] lg:h-[3.5em] w-[0] h-[0] text-white cursor-pointer"
        }
